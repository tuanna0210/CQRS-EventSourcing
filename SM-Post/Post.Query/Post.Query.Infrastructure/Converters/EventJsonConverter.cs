...
{
    /// <summary>
    /// Polimophic JSON converter to determent which concrete BaseEvent type the JSON should be deserialized.
    /// Default JSON converter is not able to do polimophism data binding or deserialization
    /// </summary>
